...
public class CustomGlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleAdminUpdateException(AdminUpdateException ex) {
        Map<String, Object> body = new HashMap<>();
        body.put("timestamp", LocalDateTime.now());
        body.put("status", HttpStatus.BAD_REQUEST);
        body.put("errors", ex.getMessage());
    ...
    @ExceptionHandler(UserNotFundraisingOwnerException.class)
    public ResponseEntity<Object> handleUserNotFundraisingOwnerException(
            UserNotFundraisingOwnerException ex) {
        Map<String, Object> body = new HashMap<>();
        body.put("timestamp", LocalDateTime.now());
        body.put("status", HttpStatus.BAD_REQUEST);
        body.put("errors", ex.getMessage());
